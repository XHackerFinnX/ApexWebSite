...
import { d as Ue, I as je, r as We, t as qe } from "./kaching-bundles-api.js";
class fe {
  constructor() {
    E(this, "t");
    E(this, "o", 0);
...
const $e = () => ke, F = (t) => {
  addEventListener("pageshow", (e) => {
    e.persisted && (ke = e.timeStamp, t(e));
  }, !0);
}, L = (t, e, n, r) => {
  let i, o;
  return (l) => {
  ...
  const n = W();
  let r = "navigate";
  return $e() >= 0 ? r = "back-forward-cache" : n && (document.prerendering || q() > 0 ? r = "prerender" : document.wasDiscarded ? r = "restore" : n.type && (r = n.type.replace(/_/g, "-"))), { name: t, value: e, rating: "good", delta: 0, entries: [], id: `v5-${Date.now()}-${Math.floor(8999999999999 * Math.random()) + 1e12}`, navigationType: r };
}, I = (t, e, n = {}) => {
  try {
...
let k = -1;
const Ce = /* @__PURE__ */ new Set(), pe = () => document.visibilityState !== "hidden" || document.prerendering ? 1 / 0 : 0, Y = (t) => {
  if (document.visibilityState === "hidden") {
    if (t.type === "visibilitychange") for (const e of Ce) e();
    isFinite(k) || (k = t.type === "visibilitychange" ? t.timeStamp : 0, removeEventListener("prerenderingchange", Y, !0));
  }
}, H = () => {
  var t;
  if (k < 0) {
    ...
    k = n != null ? n : pe(), addEventListener("visibilitychange", Y, !0), addEventListener("prerenderingchange", Y, !0), F(() => {
      setTimeout(() => {
        k = pe();
      });
    });
  ...
  const n = C(e = Object.assign({}, e), fe), r = /* @__PURE__ */ new WeakMap();
  n.t = (i) => {
    var o, l, s;
...
let Ie = 0, X = 1 / 0, j = 0;
const ze = (t) => {
  for (const e of t) e.interactionId && (X = Math.min(X, e.interactionId), j = Math.max(j, e.interactionId), Ie = j ? (j - X) / 7 + 1 : 0);
};
let Z;
const Te = () => {
  var t;
  return Z ? Ie : (t = performance.interactionCount) != null ? t : 0;
}, Ge = () => {
  "interactionCount" in performance || Z || (Z = I("event", ze, { durationThreshold: 0 }));
};
let ye = 0;
class be {
  constructor() {
...
const ee = (t) => {
  ...
  const n = C(e = Object.assign({}, e), be);
  let r = [], i = [], o = 0;
  ...
  const v = (a, u) => {
    ...
    return ((g) => {
      ...
      const S = g.interactionTime, $ = g.inputDelay, ae = g.processingDuration;
      let J, V, z = 0, R = 0, G = 0, K = 0;
      for (const B of g.longAnimationFrameEntries) {
        ...
        for (const M of B.scripts) {
          ...
          z += U - de, R += de, U > K && (V = M.startTime < S + $ ? "input-delay" : M.startTime >= S + $ + ae ? "presentation-delay" : "processing-duration", J = M, K = U);
        }
      }
      const Q = g.longAnimationFrameEntries.at(-1), ce = Q ? Q.startTime + Q.duration : 0;
      ce >= S + $ + ae && (G = g.nextPaintTime - ce), J && V && (g.longestScript = { entry: J, subpart: V, intersectingDuration: K }), g.totalScriptDuration = z, g.totalStyleAndLayoutDuration = R, g.totalPaintDuration = G, g.totalUnattributedDuration = g.nextPaintTime - S - z - R - G;
    })(N), Object.assign(a, { attribution: N });
  };
  I("long-animation-frame", (a) => {
    r = r.concat(a), f();
  }), ((a, u = {}) => {
    ...
    ie(() => {
      ...
      }, w = I("event", b, { durationThreshold: (_ = u.durationThreshold) != null ? _ : 40 });
...
const Ee = [2500, 4e3], Qe = (t, e = {}) => {
  const n = C(e = Object.assign({}, e), Me), r = /* @__PURE__ */ new WeakMap();
  n.m = (i) => {
    var l, s;
    const o = i.element;
    if (o) {
    ...
    ie(() => {
      ...
      }, v = I("largest-contentful-paint", h);
      if (v) {
...
}, Xe = "widget_web_vitals_v1", Ae = "kaching-bundle, kaching-bundles-block, .kaching-bundles, .kaching-bundles-sticky-atc-wrapper", oe = "kaching-bundles", Ye = "kaching-bundle";
let se = () => ({
  bundleImportMs: void 0,
  widgetMountedMs: void 0,
  widgetInsertedAt: 0,
  widgetElement: void 0
}), Le = !1, A, O, P, Oe = 0, Pe = 0, Re = 0, xe = 0, Fe = 0;
const ft = (t) => {
  se = t, Qe((e) => A = e, { reportAllChanges: !0 }), Ve((e) => O = e, { reportAllChanges: !0 }), Ke((e) => P = e, { reportAllChanges: !0 }), Ze(), et(), document.addEventListener("visibilitychange", () => {
  ...
  for (const n of (e = t.sources) != null ? e : []) {
    const r = n.node;
    if (r instanceof Element && r.closest(Ae))
      return !0;
  }
  return !1;
}, nt = (t) => {
  ...
  if (!Le) {
    ...
    try {
      const { bundleImportMs: i, widgetMountedMs: o } = se(), l = navigator.connection, s = {
        lcp: A ? Math.round(A.value) : void 0,
      ...
      Ue("web vitals", s), je(Xe, s, 1, { keepalive: !0 });
    } catch (i) {
      console.error(i);
    }
  }
}, rt = () => We() || qe() ? !0 : [A, O, P].some(
  (t) => t && t.rating !== "good"
), it = () => ({
  lcp: A && ot(A),
  cls: O && st(O),
